...
init python:
    gallery_content = [
        ...
        ( "thumbnails/kerosenethumbnail.png", "Kerosene", "AnagramDaine"),
        ( "thumbnails/catfieldthumbnail.png", "Catfield", "AnagramDaine"),
        ( "thumbnails/woodtrail1thumbnail.png", "Woodtrail", "AnagramDaine"),
        ( "thumbnails/woodtrail2thumbnail.png", "Woodtrail 2", "AnagramDaine"),
        ( "thumbnails/sunsetthumbnail.png", "Sunset", "AnagramDaine"),
